 ...
 */
@Slf4j
public class XhBizException extends com.likone.cloud.likspace.resources.exceptions.BusinessException {
	 ...
	 * @param args      the args
	 */
	public XhBizException(int code, String msgFormat, Object... args) {
	 ...
	 * @param msg  the msg
	 */
	public XhBizException(int code, String msg) {
		super(code, msg);
		log.info("<== MdcRpcException, code:{}, message:{}", this.code, super.getMessage());
	}
	 ...
	 */
	public XhBizException(ErrorCodeEnum codeEnum) {
	 ...
	 * @param args     the args
	 */
	public XhBizException(ErrorCodeEnum codeEnum, Object... args) {
		super(codeEnum, args);
		log.info("<== MdcRpcException, code:{}, message:{}", this.code, super.getMessage());
	}
}
